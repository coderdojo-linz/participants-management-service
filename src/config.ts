...
export const MONGO_URL = process.env.MONGO_URL || "mongodb://<dbuser>:<dbpassword>@<server>.mlab.com:<port>";
export const MONGO_DB = process.env.MONGO_DB || "member-management";
...
export const CODER_TICKET_CLASS_NAMES = process.env.CODER_TICKET_CLASS_NAME || CODER_TICKET_CLASS_NAME + "|Master Coder";
...
export const AUTH0_SECRET = process.env.AUTH0_SECRET || "my$uperS3cr3!";
export const AUTH0_CLIENT = process.env.AUTH0_CLIENT || "123456789";
export const AUTH0_SECRET_SESSIONPICKER = process.env.AUTH0_SECRET_SESSIONPICKER || "my$uperS3cr3!";
export const AUTH0_CLIENT_SESSIONPICKER = process.env.AUTH0_CLIENT_SESSIONPICKER || "123456789";
